...
@Entity
@Table(name = "ventasapp_tipocliente", schema = "test01")
public class VentasappTipoclienteEntity {
    ...
    @OneToMany(mappedBy = "ventasappTipoclienteByTipoClienteId")
    private Collection<VentasappClienteEntity> ventasappClientesByIdTipoCliente;
    ...
    public boolean equals(Object o) {
        ...
        VentasappTipoclienteEntity that = (VentasappTipoclienteEntity) o;
    ...
    public Collection<VentasappClienteEntity> getVentasappClientesByIdTipoCliente() {
        return ventasappClientesByIdTipoCliente;
    }

    public void setVentasappClientesByIdTipoCliente(Collection<VentasappClienteEntity> ventasappClientesByIdTipoCliente) {
        this.ventasappClientesByIdTipoCliente = ventasappClientesByIdTipoCliente;
    }
}
